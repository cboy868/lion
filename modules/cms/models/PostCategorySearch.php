...
/**
 * PostCategorySearch represents the model behind the search form about `app\modules\cms\models\PostCategory`.
 */
class PostCategorySearch extends PostCategory
{
    ...
    {
        return [
            [['id', 'pid', 'level', 'cover', 'sort', 'created_at', 'status'], 'integer'],
