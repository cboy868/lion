...
<div class="page-content">
    ...
    <div class="page-content-area">
        <div class="page-header">
            ...
            -->
                <small>
                    <a href="<?=Url::to(['create', 'pid'=>$mod->id])?>" class='btn btn-primary btn-sm modalAddButton' title="添加分类"
                ...
                <div class="pull-right nc">
                    <a class="btn btn-info btn-sm" href="<?=Url::toRoute(['/cms/admin/default/index', 'id'=>$mod->id])?>">
                        <i class="fa fa-list-ol fa-2x"></i>  内容管理</a>
                </div>
