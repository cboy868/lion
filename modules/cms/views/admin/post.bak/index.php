 ...
 ?>
            ...
            <div class="col-xs-2">
                 <ul class="nav nav-list">
                     <?=  Html::a('<i class="fa fa-plus"></i> 添加顶级分类', ['/cms/admin/category/create','res_name'=>'post'.$mod], ['class' => 'btn btn-primary btn-sm modalAddButton', 'style'=>'width:100%',"data-loading-text"=>"页面加载中, 请稍后...", "onclick"=>"return false"]) ?>
                     <li>
                    ...
                    <?php foreach ($cates as $key => $value): ?>
                        <li class="<?php if(isset($value['child'])){echo 'p-menu';}?>">
                                ...
                                <ul class="rmenu">
                                    <li><a href="<?=Url::toRoute(['/cms/admin/category/create', 'pid'=>$value['id'], 'res_name'=>'post'.$mod])?>" class="modalAddButton" data-loading-text="页面加载中, 请稍后..." onclick="return false">添加</a></li>
                                    <?php if (!isset($value['child'])): ?>
                                        <hr>
                                    ...
                                    <?php if (!isset($val['child'])): ?>
                                        <?php if (isset($val['url'])): ?>
                                            <li class="<?php if ($val['id'] == $current_cate) { echo 'active'; } ?>" rel="">
                                                ...
                                                <ul class="rmenu">
                                                    <li><a href="<?=Url::toRoute(['/cms/admin/category/create', 'pid'=>$val['id'], 'res_name'=>'post'.$mod])?>" class="modalAddButton" data-loading-text="页面加载中, 请稍后..." onclick="return false">添加</a></li>
                                                    <hr>
