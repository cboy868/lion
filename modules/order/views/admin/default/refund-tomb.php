...
$this->title = $tomb->tomb_no . '墓位进行退款操作';
		...
		<div class="row">
			<div class="col-xs-12 order-update">
				...
				<div class="order-form">
                    ...
                    <?= $form->field($refund, 'order_id')
                            ->dropDownList($osel,['class'=>'form-control ordersel','prompt'=>'请选择要退款的订单'])
                            ->label('选择订单');
                    ?>
                        ...
                        <table class="table noborder orels" style="max-width:700px;">
                            ...
                            <?php foreach ($orders as $order):?>
                                ...
                                >
                                    ...
                                    <td>
                                        <input type="text" name="uprice[<?=$rel->id?>]" class="uprice form-control">
                                    </td>
                                </tr>
                                <?php endforeach;?>
                            <?php endforeach;?>
