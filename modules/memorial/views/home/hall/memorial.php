    ...
    <div class="col-md-12">
        ...
        <div class="op-box">
            ...
            <div class="row">
                <!--
                <div class="col-md-6">
                    <div class="pray-b marb50">
                        <h4>
                            <a data-type="0" class="pray" href="/home/memorial/prayit?id=5&type=0" title="我要送花">
                                <img src="static/memorial/common/images/send_flower.png" alt="我要送花">
                            </a>
                        </h4>
                        <div class="flower-pic">
                            <img class="png" src="static/memorial/common/images/ink_flower.png" alt="我要送花">
                        </div>
                        <ul class="clearfix">
                        </ul>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="pray-b marb50">
                        <h4>
                            <a data-type="1" class="pray" href="/home/memorial/prayit?id=5&type=1" title="我要点烛">
                                <img src="static/memorial/common/images/send_candle.png" alt="我要点烛">
                            </a>
                        </h4>
                        <div class="candle-pic">
                            <img class="png" src="static/memorial/common/images/ink_candle.png" alt="我要点烛">
                        </div>
                        <ul class="clearfix">
                        </ul>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="pray-b marb50">
                        <h4>
                            <a data-type="2" title="我送早餐" href="/home/memorial/prayit?id=5&type=2" class="pray">
                                <img alt="我送早餐" src="static/memorial/common/images/give_btn1.png">
                            </a>
                        </h4>
                        <div class="give1">
                            <img alt="我送早餐" src="static/memorial/common/images/give1.png" class="png">
                        </div>
                        <ul class="clearfix">
                        </ul>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="pray-b marb50">
                        <h4>
                            <a data-type="3" title="我送午餐" href="/home/memorial/prayit?id=5&type=3" class="pray">
                                <img alt="我送午餐" src="static/memorial/common/images/give_btn3.png">
                            </a>
                        </h4>
                        <div class="give3">
                            <img alt="我送午餐" src="static/memorial/common/images/give3.png" class="png">
                        </div>
                        <ul class="clearfix">
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="pray-b marb50">
                        <h4>
                            <a data-type="4" title="我送晚餐" href="/home/memorial/prayit?id=5&type=4" class="pray">
                                <img alt="我送晚餐" src="static/memorial/common/images/give_btn2.png">
                            </a>
                        </h4>
                        <div class="give2">
                            <img alt="我送晚餐" src="static/memorial/common/images/give2.png" class="png">
                        </div>
                        <ul class="clearfix">
                        </ul>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="pray-b marb50">
                        <h4>
                            <a data-type="5" title="我送棉被" href="/home/memorial/prayit?id=5&type=5" class="pray">
                                <img alt="我送棉被" src="static/memorial/common/images/give_btn4.png">
                            </a>
                        </h4>
                        <div class="give4">
                            <img alt="我送棉被" src="static/memorial/common/images/give4.png" class="png">
                        </div>
                        <ul class="clearfix">
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="pray-b marb50">
                        <h4>
                            <a data-type="6" title="我送水果" href="/home/memorial/prayit?id=5&type=6" class="pray">
                                <img alt="我送水果" src="static/memorial/common/images/give_btn5.png">
                            </a>
                        </h4>
                        <div class="give5">
                            <img alt="我送水果" src="static/memorial/common/images/give5.png" class="png">
                        </div>
                        <ul class="clearfix">
                        </ul>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="pray-b marb50">
                        <h4>
                            <a data-type="7" title="我送衣服" href="/home/memorial/prayit?id=5&type=7" class="pray">
                                <img alt="我送衣服" src="static/memorial/common/images/give_btn6.png">
                            </a>
                        </h4>
                        <div class="give6">
                            <img alt="我送衣服" src="static/memorial/common/images/give6.png" class="png">
                        </div>
                        <ul class="clearfix">
                        </ul>
                    </div>
