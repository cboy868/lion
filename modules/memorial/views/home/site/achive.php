                ...
                <div id="ArticleListPage">
                    ...
                    <div class="main-page">
                        ...
                        <div class="memorials-pager">
                            ...
                            <form class="PaginationMain" islocation="true" method="get" id="form92" onsubmit="return false">
                                <div>
                                    &nbsp;
                                    ...
                                    <button class="btn btn-default btn-sm" onclick="GetSubmitUrl(&#39;form92&#39;)" type="submit">确定</button>
                                </div>
                            </form>
                        </div>
