...
<div class="page-content">
    ...
    <div class="page-content-area">
        <div class="page-header">
            <h1>
                <small>
                    <?php if (Yii::$app->user->can('grave/ins-cfg/create')):?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [   
                ...
                'visibleButtons' =>[
                    'view' =>Yii::$app->user->can('grave/ins-cfg/view'),
                    'update' =>Yii::$app->user->can('grave/ins-cfg/update'),
                    'delete' =>Yii::$app->user->can('grave/ins-cfg/delete'),
                    'grave' =>Yii::$app->user->can('grave/ins-cfg/grave'),
                ],
                'buttons' => [
