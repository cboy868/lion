            ...
            <?php foreach ($models as $index => $model): ?>
                <div class="col-xs-12 address-index">
                    <div class="panel panel-info">
                        <div class="dHandler panel-heading">碑文信息 
                        ...
                        <table class="table table-condensed">
                            <tr>
                                <td><?= $form->field($model, "[$index]content")->textInput(['maxlength' => true]) ?></td>
                            </tr>
                            <tr>
                                <td><?= $form->field($model, "[$index]pre_finish")->dropDownList($dead_title,['style'=>'width:50%']) ?></td>
                            </tr>
                        </table>
