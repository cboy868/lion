                ...
                <div class="panel panel-info">
                  ...
                  <div class="panel-body">
                            ...
                            <div style="float:right;margin-right:10px;">
                                <a href="javascript:;" id="filePicker-<?=$index?>"
                                    ...
                                    data-use="original">
                                      ...
                                      <?= $form->field($model, "[$index]photo_original")
                                          ->hiddenInput(['class'=>'portrait-img', 'value'=>$model->photo_original])
                                          ->label(false) ?>
                                </a>
                            </div>
                            <div class="hr hr-18 dotted hr-double" style="clear:both;"></div>
                    ...
                    <div class="row" style="margin-top:20px;">
                        <div class="col-md-12">
                            <?= $form->field($model, "[$index]dead_ids")
                                ->checkBoxList($dead, ['style'=>'width:50%'])
                                ->label('使用人选择') ?>
                            <?php $model->use_at = $model->use_at ? $model->use_at : $pre_bury_date;?>
                            <?= $form->field($model, "[$index]use_at")
                                ->textInput(['style'=>'width:150px;', 'dt'=>'true']) ?>

                            <?= $form->field($model, "[$index]note")
                                ->textArea() ?>
                        </div>
                    </div>
                  </div>
