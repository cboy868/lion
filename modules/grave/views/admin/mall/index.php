    ...
    <div class="page-content-area">
        <div class="row" id="goods_order">
                        ...
                        <table class="table table-bordered table-hover table-condensed" id="cate-tree">
                            ...
                            <?php foreach ($goods_cates as $k => $vo): ?>
                                <tr class="cate-box"  data-tt-id="<?=$vo['id']?>" <?php if($vo['pid']!=1):?>data-tt-parent-id="<?=$vo['pid']?>" <?php endif;?>>
                                  <td><a class="goods-cate-id" href="/admin/goods/getgoods?cate_id=<?=$vo['id']?>"><?=$vo['name']?></a></td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                        </table>
            ...
            <?php endif ?>
                        ...
                        <div class="col-sm-4 goods-item" data-id="<?=$goods->id?>" data-title="<?=$goods->name?>" data-price="<?=$goods->price?>" data-img="<?=$goods->getThumb('110x110')?>" >
                                  ...
                                  <div class="media-body">
                                    ...
                                    <?php endif ?>
                                        ...
                                        <div class="text-left goods-sel-btn">
                                            <button class="btn-sub btn btn-xs btn-default" > 减 </button>
                                            <input class="goods-num" style="" type="text" value="0" size="3" />
                                            <button class="btn-add btn btn-xs btn-default"> 加 </button>
                                        </div>
                                  </div>
                                </div>
                            ...
                            <!-- <div class="row">
                                <div class="col-sm-12 text-center" style="padding-top:5px;">
                                    <img src="<?=$goods->getThumb('110x110')?>" style="width:110px;height:110px;"/> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 text-center">
                                    <small class="text-primary"><strong><?=$goods->name?></strong></small>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 text-center">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-center goods-sel-btn">
                                    <button class="btn-sub btn btn-xs btn-default" > 减 </button>
                                    <input class="goods-num" style="" type="text" value="0" size="3" />
                                    <button class="btn-add btn btn-xs btn-default"> 加 </button>
                                </div>
                ...
                <button type="button" class="btn btn-info buy">提交</button>
            </form>
        </div>
...
$(function(){
    ...
    $('#btn-plus').click(function(e){
        e.preventDefault();
        cateTree.treetable('expandAll');
    });
    $('#btn-times').click(function(e){
        e.preventDefault();
        cateTree.treetable('collapseAll');
    });
    // -----------------------------------
    ...
    // 调取分类
    $('a.goods-cate-id').click(function(e){
        e.preventDefault();
        var $this = $(this);
