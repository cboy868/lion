...
div.goods-item{ border:1px solid white; }
                ...
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified goods-nav" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#goods-list-box" aria-controls="goods-list-box" role="tab" data-toggle="tab"><i class="fa fa-fw fa-list"></i> <?=$tname?>列表</a>
                        </li>
                        <li role="presentation">
                            <a href="#goods-selected-box" aria-controls="goods-selected-box"role="tab"data-toggle="tab"><i class="fa fa-fw fa-check-square-o "></i> 已定<?=$tname?></a>
                        </li>
                    </ul>
                                    ...
                                    <div class="panel panel-primary nav nav-tabs"role="tablist">
                                      <div class="panel-heading">
                                        ...
                                        <table class="table table-bordered table-hover table-condensed" id="cate-tree">
                                            ...
                                            <tbody>
                                            <?php $first = $goods_cates[0]['id']; ?>
                                            <?php foreach ($goods_cates as $k => $vo): ?>
                                                <tr class="cate-box"  data-tt-id="<?=$vo['id']?>" <?php if($vo['pid']!=1):?>data-tt-parent-id="<?=$vo['pid']?>" <?php endif;?>>
                                                  <td role="presentation" class="<?php if($k == 0){echo 'active';}?>">
                                                    <?php if ($vo['is_leaf'] == 1): ?>
                                                        <a class="" href="#goods<?=$vo['id']?>" role="tab" data-toggle="tab"><?=$vo['name']?></a>
                                                    <?php else: ?>
                                                        <a class="" href="#" role="tab" data-toggle="tab"><?=$vo['name']?></a>
                                                    <?php endif ?>
                                                  </td>
                                                </tr>
                                            <?php endforeach ?>
                            ...
                            <?php endif ?>
                                    <div class="tab-content">
                                        <?php foreach ($categorys as $k => $cate): ?>
                                            <div role="tabpanel" class="tab-pane <?php if($first == $cate->id){echo 'active';}?>" id="goods<?=$cate->id?>" >
                                                <div class="row">
                                                              ...
                                                              <div class="media-body">
                                                                ...
                                                                <?php endif ?>
                                                                    ...
                                                                    <div class="text-left goods-sel-btn">
                                                                        <button type="button" class="btn-sub btn btn-xs btn-default" > 减 </button>
                                                                        <input class="goods-num" style="" type="text" value="0" size="3" />
                                                                        <button type="button" class="btn-add btn btn-xs btn-default"> 加 </button>
                                                                    </div>
                                                              </div>
                                                            </div>
                                                    </div>
