...
use app\modules\shop\models\OrderRel as OrderRelModel;

/**
 * OrderRel represents the model behind the search form about `app\modules\shop\models\OrderRel`.
 */
class OrderRel extends OrderRelModel
{
    /**
     * @inheritdoc
     */
