...
<div class="page-header">
            <h1>
                <small>
                    <a href="<?=Url::to(['attr-create', 'type_id'=>Yii::$app->request->get('id')])?>" class='btn btn-primary btn-sm modalAddButton' data-loading-text="页面加载中, 请稍后..." onclick="return false" title="添加属性"><i class="fa fa-plus"></i>添加属性</a>
