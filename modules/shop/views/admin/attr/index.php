...
<div class="page-header">
            <h1>
                <small>
                    <a href="<?=Url::to(['create'])?>" class='btn btn-primary btn-sm modalAddButton' title="添加分类" data-loading-text="页面加载中, 请稍后..." onclick="return false"><i class="fa fa-plus"></i>添加属性</a>
                </small>
            </h1>
        </div><!-- /.page-header -->
        <?php 
            ...
            [
                ...
                'buttons' => [
                    ...
                    'view' => function($url, $model, $key) {
                        ...
                        return Html::a('添加属性值', $url, ['title' => '添加属性值'] );
                    },
                ],
