...
$this->params['breadcrumbs'][] = ['label' => '规格列表', 'url' => ['index']];
        ...
        <div class="page-header">
            <h1><?= Html::encode($this->title) ?>
                <small>
                    ...
                    <?= Html::a('添加规格值', ['/admin/shop/attr/create-val', 'tid'=>$model->type_id,'aid'=>$model->id], ['class' => 'btn btn-info btn-xs modalAddButton']) ?>
                </small>
            </h1>
        </div><!-- /.page-header -->
