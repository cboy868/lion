...
';
        ...
        return $this->redirect(['index']);
        // die(sprintf('成功生工生成 js 库地区文件 <br /> 文件大小 %s <br />文件路径 %s', filesize($file_name), $file_name));


    }

    // public function getLowerList(){
    //     $area_list = Area::getLowerList(Yii::$app->request->get('id'));
    //     return $this->json($area_list);
    // }
}
