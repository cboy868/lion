...
/**
 * AuthRoleSearch represents the model behind the search form about `sys\models\AuthRole`.
 */
class AuthRoleSearch extends AuthRole
{
    ...
    {
        $query = AuthRole::find()->where(['type'=>self::TYPE_ROLE,'level'=>self::LEVEL_ROLE]);
