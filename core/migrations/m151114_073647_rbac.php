 ...
 * @since 2.0
 */
class m151114_073647_rbac extends \yii\db\Migration
{
    /**
    ...
    public function up()
    {
        ...
        $this->createTable($authManager->itemTable, [
            ...
            'description' => $this->text(), //代码注释中的name值
            'real_title' => $this->string(255),//如果此字段不为空，则以此字段代替description
            'is_menu' => $this->smallInteger(1)->defaultValue(0),
            'level' => $this->integer(),//1module,2controller,3action,7权限组permission,8角色
