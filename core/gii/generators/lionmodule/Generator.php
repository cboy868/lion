...
namespace app\core\gii\generators\lionmodule;
...
EOD;
    ...
    public function generate()
    {
        ...
        // $files=array_merge($files,$this->generateMg($modulePath));
        $files=array_merge($files,$this->generateM($modulePath));
    ...
    private function generateAdmin($modulePath)
    {
    	...
    	$files[] = new CodeFile(
    			$modulePath . '/controllers/admin/DefaultController.php',
    			$this->render("admin-controller.php")
    	);
    	$files[] = new CodeFile(
    			$modulePath . '/views/admin/default/index.php',
    ...
    // private function generateMg($modulePath)
    // {
        
    //     $files[] = new CodeFile(
    //             $modulePath . '/controllers/mg/DefaultController.php',
    //             $this->render("mg-controller.php")
    //     );
    //     $files[] = new CodeFile(
    //             $modulePath . '/views/mg/default/index.php',
    //             $this->render("mg-view.php")
    //     );
    //     return $files;
    // }

    private function generateM($modulePath)
    {
       
        $files[] = new CodeFile(
            $modulePath . '/controllers/m/DefaultController.php',
            $this->render("m-controller.php")
        );
        $files[] = new CodeFile(
            $modulePath . '/views/m/default/index.php',
            $this->render("m-view.php")
        );
        return $files;
    }
    ...
    private function generateSetting($modulePath)
    {
        ...
        $files[] = new CodeFile(
            $modulePath . '/controllers/admin/SettingController.php',
            $this->render("setting-controller.php")
        );
        $files[] = new CodeFile(
            $modulePath . '/views/admin/setting/index.php',
    ...
    {
        return Yii::getAlias('@app').'\\modules\\'.$this->moduleDir;
    }
