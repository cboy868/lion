...
<div class="content" id="news-box">
    ...
    <div class="weui-loadmore weui-loadmore_line" v-show="pageCount==clistParams.page">
        <span class="weui-loadmore__tips">暂无更多</span>
    </div>
    ...
    var demo = new Vue({
        ...
        methods: {
            ...
            getList: function(append=false) {
                this.$http.jsonp(this.listUrl,{'jsonp':'lcb', params:this.clistParams}).then((response) => {
                    if (append) {
