...
$.fn.jCarouselLite = function(o) {
    o = $.extend({
         ...
         */
        imgSrc : {
    	            //'loading' : 'images/icon/loadinfo.net.gif',
    	            'prevCur' : 'images/icon/prev.cur',
    	            'nextCur' : 'images/icon/next.cur'
    	         },
        /**
         * 缩略图选中的class样式
         */
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.
        ...
        if (o.bigImg) {
	        ...
	        //loadingDiv += '<div class="loadingImage" style="position: absolute; text-align:left; opacity: 0.5; filter: alpha(opacity=50); visibility: hidden; background: none repeat scroll 0% 0% #000000; width: '+bigImgWrapWidth+'px; height: '+bigImgWrapHeight+'px; left:0px;">';
