...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
		...
		4、垂直偏移量 
		*/
        logo: '/static/gls/img/global/gls-txt.png',
        /*
        cklogo.png
		...
		*/
        advmarquee: escape(''),
        /*
        {a href="http://www.ckplayer.com"}{font color="#FFFFFF" size="12"}这里可以放文字广告，播放器默认使用这里设置的广告内容，如果不想在这里使用可以清空这里的内容，如果想在页面中实时定义滚动文字广告内容，可以清空这里的内容，然后在页面中设置广告函数。{/font}{/a}
