...
<?php $focus = focus(4,1);?>
<!-------------------banner图-------------start------------>
<?php if(isset($focus['focus'][0])):?>
<div class="marketing-banner myCarousel" style="background-image: url(<?=$focus['focus'][0]['cover']?>);">
    <div class="container  container-fixed">
        <p class="text-center new-banner-text1"><?=$focus['focus'][0]['title']?></p>

        <p class="text-center new-banner-text2"><?=$focus['focus'][0]['intro']?></p>
    </div>
</div>
<?php endif;?>
<!-------------------banner图-------------end-------------->
