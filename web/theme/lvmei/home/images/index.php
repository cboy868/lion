...
<head>
    ...
    <meta name="csrf-token" content="clFKRklNTmwXJQM/fCEYAEQWDSovAC0mOWV8BR4UASMUKyA3Kzp2NQ==">
    <title>My Yii Application</title>
    <link href="/assets/fc187de8/css/bootstrap.css" rel="stylesheet"></head>
<body>
...
<span class="icon-bar"></span>
<span class="icon-bar"></span></button><a class="navbar-brand" href="/">登入后台</a></div><div id="w0-collapse" class="collapse navbar-collapse"><ul id="w1" class="navbar-nav navbar-right nav"><li><a href="/home">首页</a></li>
<li><a href="/abouts.html">关于我们</a></li>
<li><form class="navbar-form" action="/home/default/logout.html" method="post">
<input type="hidden" name="_csrf" value="clFKRklNTmwXJQM/fCEYAEQWDSovAC0mOWV8BR4UASMUKyA3Kzp2NQ=="><button type="submit" class="btn btn-link">登出 (admin)</button></form></li></ul></div></div></nav>
    <div class="container">
...
<div id="yii-debug-toolbar" data-url="/debug/default/toolbar?tag=58f77dce8c045" style="display:none" class="yii-debug-toolbar-bottom"></div><style>
...
</script><script src="/assets/47339e53/jquery.js"></script>
<script src="/assets/d9d8936b/yii.js"></script>
<script src="/assets/fc187de8/js/bootstrap.js"></script></body>
</html>
