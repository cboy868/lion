            ...
            <aside class="col-md-3 col-md-offset-1">
                <div class="sidebar">
                    ...
                    <div class="block clearfix">
                        ...
                        <div class="image-box">
                            <div class="overlay-container">
                                <img src="/theme/zx/static/images/blog-sidebar.jpg" alt="">
                                <div class="overlay">
                                    <div class="overlay-links">
                                        <a href="blog-post.html"><i class="fa fa-link"></i></a>
                                        <a href="/theme/zx/static/images/blog-sidebar.jpg" class="popup-img-single" title="image title"><i class="fa fa-search-plus"></i></a>
                                    </div>
                                </div>
                            </div>
