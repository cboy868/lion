        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="text-center title">系统模块</h1>
            ...
            <div class="row" style="display: none;">
                ...
                <div class="main col-md-12">
                    ...
                    <!-- page-title start -->
                    <!-- ================ -->
                    <h1 class="page-title text-center">价格及功能</h1>
                    <br>
                    <!-- page-title end -->

                    <!-- pricing tables start -->
                    <div class="pricing-tables stripped object-non-visible animated object-visible fadeInUpSmall" data-animation-effect="fadeInUpSmall">
                        <div class="row grid-space-0">
                            ...
                            <div class="col-sm-4 plan stripped">
                                ...
                                <ul>
                                    ...
                                    <li>Bandwidth</li>
                                    <li>Databases</li>
                                    <li><a class="btn btn-default">Subscribe</a></li>
                                </ul>
                            </div>
                            <!-- pricing table end -->
                            ...
                            <div class="col-sm-4 plan stripped best-value">
                                ...
                                <ul>
                                    ...
                                    <li>1 Database</li>
                                    <li><a class="btn btn-default"><i class="fa fa-shopping-cart pr-10"></i>Add to cart</a></li>
                                </ul>
                            </div>
                            <!-- pricing table end -->
