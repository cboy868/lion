...
<div class="footer-info-container">
    <div class="footer-info">
        <div class="row nova-footer-info nova-mg-pd">
            ...
            <div class="col-md-5"><a href="#"><img title="Fence_new_products" src="./static/img/fence_thumbnail.jpg" alt="Fence_new_products"></a></div>
            <div class="col-md-7">
            ...
            <div class="col-md-3 nova-footer nova-footer-box3 collapsible mobile-collapsible">
                ...
                <p><a title="Instragram Link " href="#" target="_blank"><img src="./static/img/Instagram_Thumnail_Tiles_Page_2.png" alt=""></a></p>
            </div>
        </div>
    </div>
</div> 