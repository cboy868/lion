<div class="content">
    ...
    <div class="weui-grids whitebg" style="margin-top:5px; padding-top:0px;">
        <a href="http://m.shensuantang.com/suanming/bazi.html" class="weui-grid js_grid" data-id="button">
            <div class="weui-grid__icon">
                <img src="/theme/site/static/images/s1.png" alt="生辰八字">
            </div>
            <p class="weui-grid__label">业务办理</p>
        </a>
        <a href="http://m.shensuantang.com/zhougongjiemeng/index.html" class="weui-grid js_grid" data-id="button">
            <div class="weui-grid__icon">
                <img src="/theme/site/static/images/s2.png" alt="周公解梦">
            </div>
            <p class="weui-grid__label">纪念馆</p>
        </a>
        <a href="http://m.shensuantang.com/shouji/index.html" class="weui-grid js_grid" data-id="button">
            <div class="weui-grid__icon">
                <img src="/theme/site/static/images/shouji.png" alt="手机吉凶测算">
            </div>
            <p class="weui-grid__label">绑定账号</p>
        </a>
        <a href="http://m.shensuantang.com/xingming/index.html" class="weui-grid js_grid" data-id="button">
            <div class="weui-grid__icon">
                <img src="/theme/site/static/images/name.png" alt="姓名测算">
            </div>
            <p class="weui-grid__label">一键导航</p>
        </a>
        <a href="http://m.shensuantang.com/huangli/index.html" class="weui-grid js_grid" data-id="button">
            <div class="weui-grid__icon">
                <img src="/theme/site/static/images/m9.png" alt="今日黄历">
            </div>
            <p class="weui-grid__label">投诉建议</p>
        </a>
        <a href="http://m.shensuantang.com/qiming/index.html" class="weui-grid js_grid" data-id="button">
            <div class="weui-grid__icon">
            ...
            <div class="weui-panel__bd">
                <a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
                    ...
                    <div class="weui-media-box__bd">
                        <h4 class="weui-media-box__title">关于五一放假期间... </h4>
