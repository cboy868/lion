...
(function ($) {
    ...
    $.fn.mdatetimer = function(opts){
		var defaults = {
			...
			years : [2016, 2017,2018,2019,2020,2021,2022,2023,2024,2025], //年份，数组或字符串'2000~2015'
			nowbtn : true,
			onOk : null,
			onCancel : null,
		};
